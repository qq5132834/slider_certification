package com.navinfo.truck.pub.auth.controller;
...
public class ImageMerge {
    ...
    public static void overlyingImageTest() {
        ...
        String sourceFilePath = "D:/ccc/sanytruck1.png";
        String waterFilePath = "D:/ccc/log.png";
        String saveFilePath = "D:/ccc/sanytruck3.png";
        try {
            BufferedImage bufferImage1 = getBufferedImage(sourceFilePath);
            BufferedImage bufferImage2 = getBufferedImage(waterFilePath);

            // 构建叠加层
            BufferedImage buffImg = overlyingImage(bufferImage1, bufferImage2, 0, 0, 0.5f);
            // 输出水印图片
    ...
    public static void imageMargeTest() {
        ...
        String saveFilePath = "D:/ccc/sanytruck1.png";
        String divingPath = "D:/ccc/sanytruck2.png";
        String margeImagePath = "D:/ccc/sanytruck3.png";
        try {
